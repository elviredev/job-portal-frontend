            ...
            <div className="space-y-2">
               {['Full-time', 'Part-time', 'Contract', 'Internship', 'Freelance'].map((label) => (
                  <label key={label} className="flex items-center gap-2.5 group cursor-pointer">
                     <div className="w-4 h-4 rounded border-2 border-gray-300 group-hover:border-purple-400 transition duration-200 flex items-center justify-center shrink-0">
