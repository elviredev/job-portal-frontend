...
const Navbar = () => {
   ...
   const { user, loading, logout } = useAuth() // fetch data from AuthContext
   ...
   if (loading) return <div className='h-16 bg-white border-b border-gray-100' />
   return (
                     ...
                     <div className="flex items-center gap-3">
                        ...
                        <div className="relative" ref={dropdownRef}>
                           ...
                           >
                              ...
                              />
                              <svg className={`w-3.5 h-3.5 text-gray-400 transition duration-200 ${isDropdownOpen ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
               ...
               <div className="sm:hidden border-t border-gray-100 py-3 space-y-1">
                  ...
                  {user ? (
                     ...
                     <>
                        <NavLink
                           to="/recruiterLogin"
                           onClick={() => setMenuMobileOpen(false)} className={getNavLinkClassMobile}
                        >
                           Recruiter Login
                        </NavLink>
