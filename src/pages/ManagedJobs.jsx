...
const ManagedJobs = () => {
   ...
   const [selectedId, setSelectedId] = useState(null) // stock id à supprimer
   const [isModalOpen, setIsModalOpen] = useState(false) // modal de confirmation avant suppression
   ...
   const confirmDelete = async () => {
      ...
      try {
         ...
         await api.delete(`/jobs/${selectedId}`)
